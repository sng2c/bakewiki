...
(function () {
	...
	function appendUpload(item) {
		...
		if (isImage) {
			...
			preview.style.cssText = 'width:48px;height:48px;display:flex;align-items:center;justify-content:center;border-radius:8px;border:1px solid rgba(0,0,0,.08);overflow:hidden;flex-shrink:0';
			...
			preview = document.createElement('span');
			preview.style.cssText = 'width:48px;height:48px;display:flex;align-items:center;justify-content:center;border-radius:8px;border:1px solid rgba(0,0,0,.08);flex-shrink:0';
