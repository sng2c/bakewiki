...
Want to plug bakewiki into an LLM agent? Use the ready-made **[pi skill →](SKILL.md)** — a system prompt (setup + `bakewiki llm` usage) with skill frontmatter so pi can discover and trigger it automatically.
